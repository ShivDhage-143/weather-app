      ...
      <div className="flex justify-center">
        {stats.isDay !== 0 ? (
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-14 h-14 text-yellow-300 mt-8 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <svg
            ...
            strokeWidth={1.5}
            stroke="currentColor"
            className="w-12 h-12 text-slate-200 mt-8 text-transform scale-100 hover:scale-110 transition-transform duration-300 ease-in-out cursor-pointer"
          >
            <path
              strokeLinecap="round"
              strokeLinejoin="round"
